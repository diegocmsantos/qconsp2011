...
public class RepositorioPalestraScript extends RepositorioPalestra {
	...
	"insert into palestra(horario, titulo, palestrante, resumo,dia,trilha) values('13:00-20:00', 'Track: NET e as arquiteturas modernas', 'Vinicius Quaiato', '1', 'Sabado', '0');",
	"insert into palestra(horario, titulo, palestrante, resumo,dia,trilha) values('13:00-20:00', 'Track: Falando em Java', 'Paulo Silveira', '2', 'Sabado', '0');",
	"insert into palestra(horario, titulo, palestrante, resumo,dia,trilha) values('13:00-20:00', 'Track: Práticas e engenharia ágil: XP e além', 'Guilherme Silveira', '3', 'Sabado', '0');",
	"insert into palestra(horario, titulo, palestrante, resumo,dia,trilha) values('13:00-20:00', 'Track: Frontier: nosql, linguagens funcionais e mobile', 'Adriano Almeida', '4', 'Sabado', '0');",
